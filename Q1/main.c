...
int main()
{
    ...
    do
    {
        ...
        case 2:
            ...
            cadastrar_curso(&arv_curso, codigo_curso, quantidade_periodos,nome_curso);
            break;
        ...
        case 3:
            ...
            Arv_Cursos *curso_encontrado = localizar_curso(arv_curso, codigo_curso);
            if (!curso_encontrado)
            {
        ...
        case 6:
            ...
            printf("Digite o código do curso: ");
            scanf("%d", &codigo_curso);
            exibir_alunos_curso(aluno, codigo_curso);
            break;
        ...
        case 10:
            ...
            printf("Digite a matrícula do aluno: ");
            scanf("%d", &matricula);
            exibir_disciplinas_aluno_especifico(aluno, arv_curso, matricula);
            break;
